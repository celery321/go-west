...
// Validate checks the field values on CreateClusterRes with the rules defined
// in the proto definition for this message. If any rules are violated, the
// first error encountered is returned, or nil if there are no violations.
func (m *CreateClusterRes) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on CreateClusterRes with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// CreateClusterResMultiError, or nil if none found.
func (m *CreateClusterRes) ValidateAll() error {
	return m.validate(true)
}

func (m *CreateClusterRes) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return CreateClusterResMultiError(errors)
	}
	return nil
}

// CreateClusterResMultiError is an error wrapping multiple validation errors
// returned by CreateClusterRes.ValidateAll() if the designated constraints
// aren't met.
type CreateClusterResMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m CreateClusterResMultiError) Error() string {
	var msgs []string
	for _, err := range m {
...
func (m CreateClusterResMultiError) AllErrors() []error { return m }

// CreateClusterResValidationError is the validation error returned by
// CreateClusterRes.Validate if the designated constraints aren't met.
type CreateClusterResValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
func (e CreateClusterResValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e CreateClusterResValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e CreateClusterResValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e CreateClusterResValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e CreateClusterResValidationError) ErrorName() string { return "CreateClusterResValidationError" }

// Error satisfies the builtin error interface
func (e CreateClusterResValidationError) Error() string {
	cause := ""
	if e.cause != nil {
	...
	return fmt.Sprintf(
		"invalid %sCreateClusterRes.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = CreateClusterResValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = CreateClusterResValidationError{}
